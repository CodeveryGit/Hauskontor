...
<html>
  ...
  <body><img src="<?php the_field('b_s1_bg'); ?>" style="display: none;" class="preload">
    ...
    <div style="background-image: url(<?php the_field('b_s1_bg'); ?>)" id="block1" class="background-b">
      ...
      <div class="cont cont-b">
        <h1 id="h1" class="mainheadline"><?php the_field('b_s1_headline'); ?></h1>
        <h3 id="h3" class="headline"><?php the_field('b_s1_h3'); ?></h3>
        <p class="headline p1 p-b hide-onmobile"><?php the_field('b_s1_p'); ?></p>
        <div class="btndiv"><a href="<?php the_field('b_s1_mid_button_link'); ?>">
            <button class="btn-land btn-land-b"><?php the_field('b_s1_mid_button_text'); ?></button></a></div>
      </div>
    </div>
    <div id="block2" class="block2-b">
      <div class="content clearfix padbot padbot-b">
        <div class="lefttext">
          <h2 class="headline2 nomarg marg-b"><?php the_field('b_s2_headline'); ?></h2>
          <p class="padtwony p2 nopad"><?php the_field('b_s2_p1'); ?></p>
          <p id="padp" class="padtwony p2 nopad"><?php the_field('b_s2_p2'); ?></p>
          <p class="padtwony p2 nopad moblastp"><?php the_field('b_s2_p3'); ?></p>
        </div>
        <div class="pict pict-b"><img src="<?php the_field('b_s2_image'); ?>" class="building img-b"></div>
      </div>
    </div>
    <div style="background-image: url(<?php the_field('b_s3_bg'); ?>)" id="block3" class="landing_b">
      <div class="content clearfix">
        <div class="backgroundgradient block2-gradient-b"></div>
        <h3 class="headline2 h2white"><?php the_field('b_s3_headline'); ?></h3>
        <div class="block blockpad-b hide-onmobile">
          ...
          <div class="line"></div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('b_s3_step1'); ?></h3>
          </div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('b_s3_step2'); ?></h3>
          </div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('b_s3_step3'); ?></h3>
          </div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('b_s3_step4'); ?></h3>
          </div>
        </div>
        <div class="block hide-notmobile">
          ...
          <div class="stepstext stepstext-b">
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('b_s3_step1'); ?></h3>
            </div>
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('b_s3_step2'); ?></h3>
            </div>
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('b_s3_step3'); ?></h3>
            </div>
            <div class="quate">
              <h3 class="stepsheadline quat quat-b"><?php the_field('b_s3_step4'); ?></h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="block4" class="block4-b">
      <div class="content">
        <h3 class="headline2 letspace"><?php the_field('b_s4_headline'); ?></h3>
        <div class="contain contain-b hide-onmobile">
          <div class="row imgmax">
            <div class="custom1"><img src="<?php the_field('b_s4_image_1'); ?>" id="img1"></div>
            <div class="custom1"><img src="<?php the_field('b_s4_image_2'); ?>" id="img2" class="img2-b"></div>
            <div class="custom1"><img src="<?php the_field('b_s4_image_3'); ?>" id="img3"></div>
          </div>
          <div class="row imgmax padthirty padthirty-b">
            <div class="custom1">
              <h4 class="stepsheadline dark textwidth firsth4 firsth4-b customlineheight"><?php the_field('b_s4_head_for_image_1'); ?></h4>
              <p id="1stp" class="padtwony p2 p3 notbold textwidth textwidth-b customlineheight p-line"><?php the_field('b_s4_text_for_image_1'); ?></p>
            </div>
            <div class="custom1">
              <h4 class="stepsheadline dark textwidth second-h4 second-h4-b customlineheight"><?php the_field('b_s4_head_for_image_2'); ?></h4>
              <p class="padtwony p2 p3 textwidth textwidth-b customlineheight p-line"><?php the_field('b_s4_text_for_image_2'); ?></p>
            </div>
            <div class="custom1">
              <h4 class="stepsheadline dark textwidth customlineheight"><?php the_field('b_s4_head_for_image_3'); ?></h4>
              <p class="padtwony p2 p3 textwidth textwidth-b customlineheight p-line"><?php the_field('b_s4_text_for_image_3'); ?></p>
            </div>
          </div>
        </div>
        <div class="contain hide-notmobile">
          <div class="custom1"><img src="<?php the_field('b_s4_image_1'); ?>" class="img1">
            <h4 class="stepsheadline dark textwidth"><?php the_field('b_s4_head_for_image_1'); ?></h4>
            <p class="padtwony p2 p3 notbold textwidth firstmobp"><?php the_field('b_s4_text_for_image_1'); ?></p>
          </div>
          <div class="custom1"><img src="<?php the_field('b_s4_image_2'); ?>" class="img3">
            <h4 class="stepsheadline dark textwidth"><?php the_field('b_s4_head_for_image_2'); ?></h4>
            <p class="padtwony p2 p3 textwidth third-mobile-p"><?php the_field('b_s4_text_for_image_2'); ?></p>
          </div>
          <div class="custom1"><img src="<?php the_field('b_s4_image_3'); ?>" class="img5">
            <h4 class="stepsheadline dark textwidth"><?php the_field('b_s4_head_for_image_3'); ?></h4>
            <p class="padtwony p2 p3 textwidth"><?php the_field('b_s4_text_for_image_3'); ?></p>
          </div>
        </div>
      </div>
    </div>
    <div style="background-image: url(<?php the_field('b_s5_bg'); ?>)" id="block5" class="bg-b5">
      <div class="content">
        <div class="backgroundgradient2 grad-b-s5"></div>
        <p class="headline p1 p1-b block5headline"><?php the_field('b_s5_text'); ?></p>
        <div class="btndiv btndivlesspad pad-b"><a href="<?php the_field('b_s5_button_link'); ?>">
            <button class="btn-land btn-b btn-b-b"><?php the_field('b_s5_button_text'); ?></button></a></div>
      </div>
    </div>
    <div id="section7" class="sect7">
      <div id="say"><?php the_field('b_s6_text'); ?></div>
      <div id="sign"><?php the_field('b_s6_text_sign'); ?></div>
    </div>
    <div id="section6" class="sect6">
      ...
      <!--        label#dokumentenverwaltung(for="dokumentenverwaltung") &#x276F;-->
      <!--        label#dienstleistungen-buchen(for="dienstleistungen-buchen") &#x276F;-->
      <div id="slider-content" class="slider-cont-b only-b">
        <div id="slider-header" class="header-b"><?php the_field('b_s7_headline'); ?></div>
        <div id="slider-page" class="page-b pageheight-b only-b">
          <div id="immobilienubersicht">
            <p class="padtwelve only-b"><?php the_field('b_s7_p1'); ?></p>
            <p class="padtwelve only-b"><?php the_field('b_s7_p2'); ?></p>
            <p class="padtwelve only-b"><?php the_field('b_s7_p3'); ?></p>
            <p class="padtwelve bold"><?php the_field('b_s7_p4'); ?></p>
          </div>
      ...
      <div id="slider-image" class="slider-b only-b">
        <div id="tablet">
          <div id="image-placeholder"><img id="immobilienubersicht" src="<?php the_field('b_s7_slide'); ?>"><img id="kommunikation-mit-mietern"><img id="dokumentenverwaltung"><img id="dienstleistungen-buchen"></div>
        </div>
      </div>
    </div>
    <div id="section8" class="sect8">
      <div id="background" style="background-image: url(<?php the_field('b_s8_bg'); ?>)" class="bg-b8">
        <div id="grad-b-s8">
          <div class="wrapper wrapper-b">
            <div id="line" class="line-b"><?php the_field('b_s8_text'); ?></div>
            <label>
              <button></button><a href="<?php the_field('b_s8_button_link'); ?>">
                <div class="button button-b"><?php the_field('b_s8_button_text'); ?></div></a>
            </label>
          </div>
        </div>
      </div>
