...
<html>
  ...
  <body><img src="<?php the_field('c_section1_background'); ?>" style="display: none;" class="preload">
    ...
    <div id="block1" style="background-image: url(<?php the_field('c_section1_background'); ?>) !important;" class="background-b">
      <div class="head clearfix hide-onmobile">
        <div class="logo"><a href="<?php the_field('header_logo_link', 456); ?>"><img src="<?php the_field('header_logo', 456); ?>"></a></div><?php if (is_user_logged_in()): ?><a href="<?php the_field('loggined_button_link', 456); ?>">
          <button class="return signup login">Portal</button></a><?php else: ?><a href="<?php the_field('second_button_link', 456); ?>">
      ...
      <div class="cont cont-b">
        <h1 id="h1" class="mainheadline"><?php the_field('C_section1_header'); ?></h1>
        <h3 id="h3" class="headline"><?php the_field('C_section1_text1'); ?></h3>
        <p class="headline p1 p-b hide-onmobile"><?php the_field('C_section1_text2'); ?></p>
        <div class="btndiv"><a href="<?php the_field('c_section1_button_link'); ?>">
            <button class="btn-land"><?php the_field('C_section1_button'); ?></button></a></div>
      </div>
    </div>
    <div id="block2" class="block2-b">
      <div class="content clearfix padbot padbot-b">
        <div class="lefttext">
          <h2 class="headline2 nomarg marg-b"><?php the_field('c_section2_header'); ?></h2>
          <p class="padtwony p2 nopad"><?php the_field('c_section2_paragraph1'); ?></p>
          <p id="padp" class="padtwony p2 nopad"><?php the_field('c_section2_paragraph2'); ?></p>
        </div>
        <div class="pict"><img src="<?php the_field('c_section2_image'); ?>" class="building img-b">
          <!--img(src!="<?php echo get_template_directory_uri(); ?>/assets/img/illu-1.png").building.hide-notmobile.mobimg-->
        </div>
      </div>
    </div>
    <div id="block3" style="background-image: url(<?php the_field('c_section3_background'); ?>) !important;" class="landing_b">
      <div class="content clearfix">
        <div class="backgroundgradient block2-gradient-b"></div>
        <h3 class="headline2 h2white"><?php the_field('c_section3_header'); ?></h3>
        <div class="block blockpad-b hide-onmobile">
          ...
          <div class="quater docimg"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/doc+galka.png"></div>
          <div class="line"></div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('c_section3_1'); ?></h3>
          </div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('c_section3_2'); ?></h3>
          </div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('c_section3_3'); ?></h3>
          </div>
          <div class="steps">
            <h3 class="stepsheadline stepshead-b"><?php the_field('c_section3_4'); ?></h3>
          </div>
        </div>
        <div class="block hide-notmobile">
          ...
          <div class="stepstext stepstext-b">
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('c_section3_1'); ?></h3>
            </div>
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('c_section3_2'); ?></h3>
            </div>
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('c_section3_3'); ?></h3>
            </div>
            <div class="quater">
              <h3 class="stepsheadline quat quat-b"><?php the_field('c_section3_4'); ?></h3>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="block4" class="block4-b">
      <div class="content">
        <h3 class="headline2 letspace"><?php the_field('c_section4_header'); ?></h3>
        <div class="contain contain-b hide-onmobile">
          <div class="row imgmax">
            <div class="custom1"><img src="<?php the_field('c_section4_column1_image'); ?>" id="img1"></div>
            <div class="custom1"><img src="<?php the_field('c_section4_column2_image'); ?>" id="img2" class="img2-b"></div>
            <div class="custom1"><img src="<?php the_field('c_section4_column3_image'); ?>" id="img3"></div>
          </div>
          <div class="row imgmax padthirty padthirty-b">
            <div class="custom1">
              <h4 class="stepsheadline dark textwidth firsth4 firsth4-b customlineheight"><?php the_field('c_section4_column1_header'); ?></h4>
              <p id="1stp" class="padtwony p2 p3 notbold textwidth textwidth-b customlineheight p-line"><?php the_field('c_section4_column1_text'); ?></p>
            </div>
            <div class="custom1">
              <h4 class="stepsheadline dark textwidth second-h4 customlineheight"><?php the_field('c_section4_column2_header'); ?></h4>
              <p class="padtwony p2 p3 textwidth textwidth-b customlineheight p-line"><?php the_field('c_section4_column2_text'); ?></p>
            </div>
            <div class="custom1">
              <h4 class="stepsheadline dark textwidth customlineheight"><?php the_field('c_section4_column3_header'); ?></h4>
              <p class="padtwony p2 p3 textwidth textwidth-b customlineheight p-line"><?php the_field('c_section4_column3_text'); ?></p>
            </div>
          </div>
        </div>
        <div class="contain hide-notmobile">
          <div class="custom1"><img src="<?php the_field('c_section4_column1_image'); ?>" class="img1">
            <h4 class="stepsheadline dark textwidth"><?php the_field('c_section4_column1_header'); ?></h4>
            <p class="padtwony p2 p3 notbold textwidth firstmobp"><?php the_field('c_section4_column1_text'); ?></p>
          </div>
          <div class="custom1"><img src="<?php the_field('c_section4_column2_image'); ?>" class="img3">
            <h4 class="stepsheadline dark textwidth"><?php the_field('c_section4_column2_header'); ?></h4>
            <p class="padtwony p2 p3 textwidth third-mobile-p"><?php the_field('c_section4_column2_text'); ?></p>
          </div>
          <div class="custom1"><img src="<?php the_field('c_section4_column3_image'); ?>" class="img5">
            <h4 class="stepsheadline dark textwidth"><?php the_field('c_section4_column3_header'); ?></h4>
            <p class="padtwony p2 p3 textwidth"><?php the_field('c_section4_column3_text'); ?></p>
          </div>
        </div>
      </div>
    </div>
    <div id="block5" style="background-image: url(<?php the_field('c_section5_background'); ?>);">
      <div class="content">
        <div class="backgroundgradient2"></div>
        <p class="headline p1 p1-b block5headline"><?php the_field('c_section5_text'); ?></p>
        <div class="btndiv btndivlesspad pad-b"><a href="<?php the_field('c_section5_button_link'); ?>">
            <button class="btn-land btn-b btn-b-b"><?php the_field('c_section5_button'); ?></button></a></div>
      </div>
    </div>
    <div id="section7" class="sect7">
      <div id="say"><?php the_field('c_section6_text'); ?></div>
      <div id="sign"><?php the_field('c_section6_name'); ?></div>
    </div>
    <div id="section6" class="sect6">
      ...
      <div id="slider-content" class="slider-cont-b">
        <div id="slider-header" class="header-b"><?php the_field('c_section7_header'); ?></div>
        <div id="slider-page" class="page-b pageheight-b">
          <div id="immobilienubersicht">
            <p class="padtwelve"><?php the_field('c_section7_paragraph1'); ?></p>
            <p class="padtwelve"><?php the_field('c_section7_paragraph2'); ?></p>
            <p class="padtwelve"><?php the_field('c_section7_paragraph3'); ?></p>
            <p class="padtwelve bold"><?php the_field('c_section7_endline'); ?></p>
          </div>
      ...
      <div id="slider-image" class="slider-b">
        <div id="tablet">
          <div id="image-placeholder"><img id="immobilienubersicht" src="<?php the_field('c_section7_slider_image'); ?>"><img id="kommunikation-mit-mietern"><img id="dokumentenverwaltung"><img id="dienstleistungen-buchen"></div>
        </div>
      </div>
    </div>
    <div id="section8" class="sect8">
      <div id="background" style="background-image: url(<?php the_field('c_section8_background'); ?>) !important;">
        <div id="background-gradient">
          <div class="wrapper wrapper-b">
            <div id="line" class="line-b"><?php the_field('c_section8_text'); ?></div>
            <label>
              <button></button><a href="<?php the_field('c_section8_button_link'); ?>">
                <div class="button button-b"><?php the_field('c_section8_button'); ?></div></a>
            </label>
          </div>
        </div>
      </div>
