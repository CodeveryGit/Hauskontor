  ...
  <body>
    ...
    <div id="block1" class="impressum">
      ...
      <div class="cont cont-impressum">
        <h1 id="h1" class="mainheadline"><?php the_field('terms_header'); ?></h1>
        <h3 class="stepsheadline h3-impressum"><?php the_field('terms_header_line'); ?></h3>
      </div>
    </div>
    <div id="terms" class="clearfix"><?php the_post(); echo apply_filters('the_content', get_the_content()); ?></div>
    <footer id="footer">
